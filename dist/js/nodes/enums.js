...
exports.IS_RESTARTABLE = exports.TIME_LIMIT_TYPES = exports.ETA = exports.QUEUE_DISPLAY = exports.QUEUE_TYPES = void 0;
exports.QUEUE_TYPES = {
    debug: "D",
    ordinaryRegular: "OR",
...
exports.TIME_LIMIT_TYPES = {
    single: "per single attempt",
    compound: "compound",
};
exports.IS_RESTARTABLE = {
    yes: true,
    no: false,
};
