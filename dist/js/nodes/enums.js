...
exports.TIME_LIMIT_TYPES = exports.QUEUE_TYPES = exports.QUEUE_DISPLAY = exports.IS_RESTARTABLE = exports.ETA = void 0;
const QUEUE_TYPES = {
  debug: "D",
  ordinaryRegular: "OR",
...
exports.QUEUE_DISPLAY = QUEUE_DISPLAY;
const ETA = {
  withinOneMin: {
...
exports.ETA = ETA;
const TIME_LIMIT_TYPES = {
  single: "per single attempt",
  compound: "compound"
};
exports.TIME_LIMIT_TYPES = TIME_LIMIT_TYPES;
const IS_RESTARTABLE = {
  yes: true,
  no: false
};
exports.IS_RESTARTABLE = IS_RESTARTABLE;